    ...
    <div className="about-page">
      ...
      <div className="about-content">
        ...
        <div className="about-hero">
          <h1 className="about-hero__title">About JAID</h1>
        ...
        <div className="about-section">
          ...
          <p className="about-section__body">JAID began with someone I loved who wanted to reconnect with her CHamoru heritage. I wanted to learn alongside her, not only so we could share that journey together, but because I loved her and wanted her language to live on. A dear friend and fluent CHamoru speaker became my teacher. That relationship, and the love behind it, is the reason this app exists.</p>
        ...
        <div className="about-section">
          ...
          <p className="about-section__body">Every word in JAID comes from two authoritative sources: Donald Topping's Chamorro English Dictionary and Dr. Faye Untalan's Finu' Chamorro for Beginners. Every entry is reviewed by a fluent native CHamoru speaker before it appears to any learner. We do not use AI to generate or describe CHamoru language content.</p>
        </div>
